...
const App = () => {
  ...
  const handleDetailsClick = (practiceData: any) => {
  ...
  const showPractice = (text: string) => {
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="w-full">
        <div className="hidden lg:block overflow-x-auto">
          <div className="min-w-[800px]">
            ...
            <div className="divide-y divide-border">
              {(showPractice("1 - Gestão Flexível e Compassiva de Consistência") || showPractice("Permitir que usuários definam frequências personalizadas") || showPractice("Deci & Ryan")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-background">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <CalendarCheck className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      1 - Gestão Flexível e Compassiva de Consistência
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Permitir que usuários definam frequências personalizadas de engajamento (ex: '3x por semana'), implementar pausas programadas sem penalidades, e oferecer mecanismos de recuperação gradual após falhas (mini-metas de reconstrução, mensagens de normalização).
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Deci & Ryan (1985); Busch et al. (2015); Nicholson (2015); Lally et al. (2010); Zimmerman (2002)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
                      ...
                      imageUrl: practice1,
                      source: "App Duolingo"
                    })} variant="outline" size="sm" className="gap-2 hover:bg-muted hover:text-foreground transition-all duration-200">
              ...
              {(showPractice("2 - Reconhecimento Qualitativo e Processual") || showPractice("Incorporar métricas que avaliem profundidade") || showPractice("Locke & Latham")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-muted/20">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <Award className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      2 - Reconhecimento Qualitativo e Processual
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Incorporar métricas que avaliem profundidade, maestria e estratégias de aprendizagem (não apenas volume), bonificando reflexão, revisão de erros, persistência e metacognição por meio de badges e feedbacks específicos que validem o processo.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Locke & Latham (1990); Marton & Säljö (1976); Zimmerman (2002); Nicholson (2015)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("3 - Economia Virtual Pedagogicamente Vinculada") || showPractice("Conectar moedas e recompensas virtuais") || showPractice("Kahneman & Tversky")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-background">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <Coins className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      3 - Economia Virtual Pedagogicamente Vinculada
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Conectar moedas e recompensas virtuais a ganhos funcionais reais (acesso a conteúdo avançado, ferramentas educacionais, funcionalidades do sistema) ao invés de itens puramente cosméticos.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Kahneman & Tversky (1979); Hamari, Koivisto & Sarsa (2014); Busch et al. (2015)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("4 - Badges Vinculadas a Competências Verificáveis") || showPractice("Estruturar insígnias hierarquicamente") || showPractice("Marczewski")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-muted/20">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <Medal className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      4 - Badges Vinculadas a Competências Verificáveis
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Estruturar insígnias hierarquicamente por habilidades específicas e processos de aprendizagem, conectando cada conquista a marco pedagógico ou comportamental concreto.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Marczewski (2015); Martín-Peña, García-Magro & Sánchez-López (2024)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("5 - Sistemas de Classificação Multidimensionais") || showPractice("Implementar múltiplas categorias de ranking") || showPractice("Festinger")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-background">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <BarChart3 className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      5 - Sistemas de Classificação Multidimensionais
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Implementar múltiplas categorias de ranking exibidas simultaneamente (volume, consistência, melhoria percentual, variedade de práticas), legitimando diferentes estilos de engajamento.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Festinger (1954); Nicholson (2015); Tondello et al. (2016)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("6 - Feedback Contextualizado e Educativo") || showPractice("Acompanhar todas as métricas gamificadas") || showPractice("Nielsen")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-muted/20">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <MessageSquare className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      6 - Feedback Contextualizado e Educativo
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Acompanhar todas as métricas gamificadas com mensagens que explicitem sua conexão com objetivos reais de aprendizagem, desenvolvimento ou saúde, transformando números abstratos em significado concreto.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Nielsen (1994); Zimmerman (2002); Martín-Peña, García-Magro & Sánchez-López (2024)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("7 - Detecção e Prevenção de Padrões de Uso Nocivos") || showPractice("Monitorar comportamentos de risco") || showPractice("Nicholson")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-background">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <ShieldAlert className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      7 - Detecção e Prevenção de Padrões de Uso Nocivos
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Monitorar comportamentos de risco (uso compulsivo, overtraining, sacrifício de bem-estar) e intervir proativamente com mensagens educativas e ajustes temporários de dificuldade.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Nicholson (2015); Deci, Koestner & Ryan (1999)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("8 - Colaboração Como Alternativa à Competição") || showPractice("Oferecer modos cooperativos") || showPractice("Deci & Ryan")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-muted/20">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <Users className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      8 - Colaboração Como Alternativa à Competição
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Oferecer modos cooperativos onde grupos trabalham em direção a objetivos coletivos, distribuindo reconhecimento de forma equitativa e reduzindo pressão competitiva individualista.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Deci & Ryan (1985); Marczewski (2015); Hamari, Koivisto & Sarsa (2014)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("9 - Personalização Adaptativa por Perfil Motivacional") || showPractice("Identificar perfis de usuários") || showPractice("Marczewski")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-background">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <Settings2 className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      9 - Personalização Adaptativa por Perfil Motivacional
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Identificar perfis de usuários (conforme modelo HEXAD ou similar) e ajustar interface para destacar elementos mais relevantes a cada tipo.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Marczewski (2015); Busch et al. (2015); Tondello et al. (2016)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("10 - Transparência em Sistemas Aleatórios") || showPractice("Exibir taxas aproximadas de probabilidade") || showPractice("Kahneman & Tversky")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-muted/20">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <Eye className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      10 - Transparência em Sistemas Aleatórios
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Exibir taxas aproximadas de probabilidade em sistemas de drops ou recompensas aleatórias, reduzindo frustração e percepção de arbitrariedade.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Kahneman & Tversky (1979); Nicholson (2015)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("11 - Visualização de Progressão Pessoal Longitudinal") || showPractice("Fornecer dashboards que mostrem evolução temporal") || showPractice("Locke & Latham")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-background">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <TrendingUp className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      11 - Visualização de Progressão Pessoal Longitudinal
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Fornecer dashboards que mostrem evolução temporal (gráficos de tendências, padrões históricos, comparação com desempenho anterior), destacando melhoria individual ao longo do tempo e recontextualizando posição atual como parte de trajetória pessoal.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Locke & Latham (1990); Zimmerman (2002); Hamari, Koivisto & Sarsa (2014); Martín-Peña, García-Magro & Sánchez-López (2024)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("12 - Segurança e Equidade em Contextos de Performance") || showPractice("Priorizar alertas de segurança") || showPractice("Nicholson")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-muted/20">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <Scale className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      12 - Segurança e Equidade em Contextos de Performance
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Priorizar alertas de segurança sobre incentivos de desempenho, especialmente em contextos físicos ou de saúde, e democratizar acesso a comparações calibradas por características demográficas.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Nicholson (2015); Busch et al. (2015)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("13 - Autonomia Total de Engajamento") || showPractice("Garantir que todos os elementos gamificados") || showPractice("Deci & Ryan")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-background">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <Rocket className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      13 - Autonomia Total de Engajamento
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Garantir que todos os elementos gamificados (sociais, competitivos, colecionáveis) sejam estritamente opcionais com experiência core plenamente funcional sem eles, e validar explicitamente escolhas de não-participação através de mensagens e badges que legitimem diferentes estilos.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Deci & Ryan (1985); Nicholson (2015); Marczewski (2015); Busch et al. (2015)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("14 - Fragmentação de Objetivos de Longo Prazo em Marcos Intermediários") || showPractice("Dividir metas distantes") || showPractice("Locke & Latham")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-muted/20">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <Flag className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      14 - Fragmentação de Objetivos de Longo Prazo em Marcos Intermediários
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Dividir metas distantes em conquistas menores e celebráveis, reduzindo distância psicológica entre esforço e recompensa e mantendo senso de progresso contínuo.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
              ...
              {(showPractice("15 - Narrativa e Construção de Identidade Progressiva") || showPractice("Estruturar conquistas como arcos narrativos") || showPractice("Marczewski")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-background">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <BookOpen className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      15 - Narrativa e Construção de Identidade Progressiva
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Estruturar conquistas como arcos narrativos que comuniquem evolução de identidade (ex: 'Novato → Aprendiz → Praticante → Mestre'), utilizando linguagem, títulos e progressão visual que reforcem transformação pessoal ao longo da jornada.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Marczewski (2015); Nicholson (2015); Martín-Peña, García-Magro & Sánchez-López (2024)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("16 - Transparência de Propósito e Design Intencional") || showPractice("Explicitar claramente o propósito pedagógico") || showPractice("Nicholson")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-muted/20">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <Lightbulb className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      16 - Transparência de Propósito e Design Intencional
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Explicitar claramente o propósito pedagógico, comportamental ou de bem-estar de cada mecânica gamificada, comunicando aos usuários POR QUE cada elemento existe e COMO contribui para objetivos reais (não apenas 'porque é divertido').
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Nicholson (2015); Deterding et al. (2011); Deci & Ryan (1985)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("17 - Integração com Contexto e Objetivos Externos") || showPractice("Permitir que usuários conectem atividades gamificadas") || showPractice("Deci & Ryan")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-background">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <Puzzle className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      17 - Integração com Contexto e Objetivos Externos
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Permitir que usuários conectem atividades gamificadas a metas, projetos ou contextos reais através de sincronizações (calendários, ferramentas de trabalho, objetivos de vida), evitando que sistema se torne isolado da realidade do usuário.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Deci & Ryan (1985); Busch et al. (2015); Nicholson (2015)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("18 - Redundância Motivacional - Múltiplas Portas de Entrada") || showPractice("Oferecer diversos sistemas motivacionais") || showPractice("Marczewski")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-muted/20">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <Layers className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      18 - Redundância Motivacional - Múltiplas Portas de Entrada
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Oferecer diversos sistemas motivacionais simultâneos (progressão numérica, coleção, narrativa, social) para que quando um perde eficácia, outros mantenham engajamento, evitando pontos únicos de falha motivacional.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Marczewski (2015); Hamari, Koivisto & Sarsa (2014)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("19 - Ritmo Respiratório e Momentos de Pausa Estruturada") || showPractice("Incorporar ciclos de intensidade/descanso") || showPractice("Nicholson")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-background">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <PauseCircle className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      19 - Ritmo Respiratório e Momentos de Pausa Estruturada
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Incorporar ciclos de intensidade/descanso ao design, incentivando ativamente períodos de recuperação por meio de mensagens, ajustes de dificuldade temporários, e validação de que 'não fazer' é parte estratégica de progressão sustentável.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Nicholson (2015); Deci, Koestner & Ryan (1999); Lally et al. (2010)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
              ...
              {(showPractice("20 - Camadas de Profundidade Progressiva (Onboarding Gradual)") || showPractice("Revelar complexidade do sistema gradualmente") || showPractice("Nielsen")) && (
                <div className="grid grid-cols-5 hover:bg-muted/50 transition-all duration-200 hover:shadow-sm bg-muted/20">
                  <div className="p-4 flex items-center justify-center border-r border-border bg-card">
                    <div className="group transition-transform duration-300 hover:scale-110">
                      <ArrowUpNarrowWide className="w-8 h-8 text-primary transition-all duration-300 group-hover:rotate-12 group-hover:text-accent" />
                    </div>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <h3 className="font-semibold text-foreground">
                      20 - Camadas de Profundidade Progressiva (Onboarding Gradual)
                    </h3>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground">
                      Revelar complexidade do sistema gradualmente, começando com mecânicas core simples e desbloqueando elementos avançados (economia, social, customização) conforme usuário demonstra domínio, evitando sobrecarga cognitiva inicial.
                    </p>
                  </div>
                  <div className="p-4 flex items-center border-r border-border bg-card">
                    <p className="text-sm text-muted-foreground line-clamp-3">
                      Nielsen (1994); Csikszentmihalyi (1990); Tondello et al. (2016)
                    </p>
                  </div>
                  <div className="p-4 flex items-center justify-center bg-card">
                    <Button onClick={() => handleDetailsClick({
        ...
        <div className="lg:hidden px-4 py-6 space-y-4">
          {(showPractice("1 - Gestão Flexível e Compassiva de Consistência") || showPractice("Permitir que usuários definam frequências personalizadas") || showPractice("Deci & Ryan")) && (
            <div className="rounded-lg border border-border overflow-hidden hover:shadow-md transition-all duration-300 bg-background">
              <div className="p-4 space-y-3">
                ...
                <Button onClick={() => handleDetailsClick({
                  ...
                  imageUrl: practice1,
                  source: "App Duolingo"
                })} variant="outline" size="sm" className="w-full gap-2 hover:bg-muted hover:text-foreground transition-all duration-200">
                  <Info className="w-4 h-4" />
          ...
          {(showPractice("2 - Reconhecimento Qualitativo e Processual") || showPractice("Incorporar métricas que avaliem profundidade") || showPractice("Locke & Latham")) && (
            <div className="rounded-lg border border-border overflow-hidden hover:shadow-md transition-all duration-300 bg-muted/20">
              <div className="p-4 space-y-3">
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0">
                    <div className="group transition-transform duration-300 hover:scale-110">
          ...
          <DialogContent className="max-w-4xl max-h-[85vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-primary">
                {selectedPractice.number}. {selectedPractice.title}
              </DialogTitle>
            ...
            <div className="w-full rounded-lg overflow-hidden border border-border">
              <img 
                src={selectedPractice.imageUrl} 
                alt={`Ilustração de ${selectedPractice.title}`}
                className="w-full h-auto object-cover hover:scale-105 transition-transform duration-500"
              />
            </div>
            {selectedPractice.source && (
              <p className="text-sm text-muted-foreground text-center pt-2">
                Fonte: {selectedPractice.source}
              </p>
            )}
            ...
            <div className="space-y-6 pt-4">
              <div>
                ...
                <p className="text-muted-foreground">{selectedPractice.theoreticalBase}</p>
              </div>
              <div>
                <h3 className="font-semibold text-lg mb-2 text-foreground">Detalhes Completos</h3>
                <div className="space-y-3 text-muted-foreground">
                  {selectedPractice.details.map((detail: string, index: number) => (
              ...
              {selectedPractice.examples && selectedPractice.examples.length > 0 && (
                <div>
                  <h3 className="font-semibold text-lg mb-2 text-foreground">Exemplos</h3>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                    {selectedPractice.examples.map((example: string, index: number) => (
